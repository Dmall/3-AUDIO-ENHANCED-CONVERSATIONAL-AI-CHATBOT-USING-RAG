...
# def save_audio(url): # Download Yt Video And Converts Into Specific Audio Format And Save It A Particular Directory 
#     try:
...
# def assemblyai_stt(audio_filename): # Converts An Audio File To Text, Stores "Transcribed_Text" And "Transcribed_Word_Timestamps" Into A Specific Directory
#     try:
...
# @st.cache_resource # [For Saved User Asked Questions For Avoiding Giving The Same Answer Again And Again]
# def setup_qa_chain(): # Basically We Are Builing "RAG"
#     try:
...
#                     # Find and display relevant timestamps along with the output
...
# # Cleanup temporary files when uesr refresh the page
